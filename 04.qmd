...
Geometrically, we can think of the basis functions as a set of coordinate axes spanning a feature space, and $\mathbf{w}^\top \mathbf{\phi}(\mathbf{x}_n)$ as a linear combination of these axes that lies in the feature space. The target is a vector outside this subspace, and the least squares solution is the orthogonal projection of the target onto the subspace spanned by the basis functions.
...
...And regularisation as a middle ground.